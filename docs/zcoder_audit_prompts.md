...
```
Audit {MODULE_OR_GROUP} in the zcoder codebase against Anthropic's current
...
1. Identify the exact doc page(s) this module wraps. Search for the
   ...
   live platform.claude.com / docs.claude.com page, not a cached mirror.
...
**Modules:** `claude_files.py`, `claude_code_exec.py`, `claude_sandbox.py`
...
**Modules:** `claude_models.py`, `claude_tokens.py`, `claude_stream.py`,
`claude_structured.py`, `claude_citations.py`
**Search hints:** "Claude models overview current", "token counting API",
"streaming Messages API", "structured outputs API", "citations API"
**Extra check:** `claude_models.py` is the single highest-risk module for
...
**Modules:** `claude_tools.py`, `claude_search.py`, `claude_vision.py`,
`claude_advisor.py`
...
**Modules:** `claude_agents_sdk.py`, `claude_sessions.py`, `claude_memory.py`,
`claude_workflow.py`, `claude_hooks_perms_plan.py`
...
**Modules:** `claude_admin_api.py`, `claude_compliance_api.py`,
`security.py`, `claude_wif.py`
**Search hints:** "Admin API", "workspaces API keys", "compliance API",
"workload identity federation Claude"
...
**Modules:** `claude_batch.py`, `claude_cost_optimizer.py`, `claude_cache.py`,
...
**Modules:** `claude_fable5.py`, `claude_mythos5.py`
**Search hints:** "Claude Fable 5", "Claude Mythos 5", "Anthropic Mythos tier"
...
**Modules:** `claude_chrome.py`, `claude_excel.py`, `claude_powerpoint.py`,
`claude_github.py`, `claude_git.py`
**Search hints:** "Claude in Chrome", "Claude for Excel", "Claude for
PowerPoint", "Claude GitHub integration"
**Extra check:** these wrap end-user products more than raw API surface —
confirm docs.claude.com / support.claude.com rather than the API reference,
since capabilities here change via product releases, not API versioning.

## 9. Research & prompting
**Modules:** `claude_research.py`, `claude_prompt_optimizer.py`,
`claude_rag.py`, `claude_output_styles.py`
**Search hints:** "prompt engineering overview", "output styles", "RAG
Claude best practices"

## 10. Skills & plugins
**Modules:** `claude_skills_api.py`, `claude_plugins.py`, `skills.py`
**Search hints:** "Agent Skills overview", "skills in the API", "Claude
plugins"

## 11. Observability & ops
**Modules:** `claude_observability.py`, `claude_metrics.py`, `claude_live.py`,
`health.py`, `logging_config.py`, `resilience.py`
**Search hints:** "Claude API observability", "usage and cost API"
...
## 12. Evals
**Modules:** `claude_eval.py`, `claude_evals.py`
**Search hints:** "Claude evaluations", "test and evaluate overview"

## 13. CLI/interactive/settings plumbing
**Modules:** `claude_interactive.py`, `claude_settings.py`, `claude_router.py`,
...
`main.py`'s `cmd_file_list` call still match `claude_files.py` after this
cycle's pagination change)?

## 14. Cowork / projects / artifacts
**Modules:** `cowork.py`, `projects.py`, `artifacts.py`
**Search hints:** "Claude Cowork", "Projects Claude", "Artifacts overview"
