...
def sonnet5_price(as_of: Optional[date] = None) -> dict:
...
MODEL_CATALOG: dict = {
    ...
    "claude-sonnet-5": {
        ...
        "context_window": 1_000_000, "max_output": 128_000,
        "price_in": sonnet5_price()["in"], "price_out": sonnet5_price()["out"],
        "thinking": "adaptive", "effort_default": "high",
...
def get_price(model_id: str, as_of: Optional[date] = None) -> dict:
