...
from infrastructure.voyage_api.embeddings_gateway import DEFAULT_MODEL, embed
...
def list_server_tools_info() -> list:
    ...
    for name, desc in descs.items():
        ...
        rows.append(
            {"name": name, "description": desc, "beta": beta, "tool_type": tool_type, "retired": retired}
        )
    return rows
