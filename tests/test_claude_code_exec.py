...
def _install_fake_urlopen(monkeypatch, captured_headers: dict, response_body: dict = None):
    ...
    # now lives in infrastructure/anthropic_api/code_agent_gateway.py, not
    # in this shim — patch the actual stdlib module object directly (same
    # fix as tests/test_claude_tools.py, Phase C).
